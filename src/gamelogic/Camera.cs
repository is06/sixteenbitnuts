...
namespace SixteenBitNuts
{
    public class Camera
    {
        ...
        public Matrix Transform
        {
            get
            {
                Vector2 viewPortCenter = new Vector2(map.RenderDestinationBounds.Size.X / 2, map.RenderDestinationBounds.Size.Y / 2);
        ...
        public void Update()
        {
            int hcenter = map.RenderDestinationBounds.Size.X / 2;
            int vcenter = map.RenderDestinationBounds.Size.Y / 2;
